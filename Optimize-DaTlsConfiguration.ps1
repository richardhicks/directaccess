...
.EXAMPLE
    .\Optimize-DaTlsConfiguration.ps1 -Performance
...
.DESCRIPTION
    Use this script to optimize TLS configuration to improve security and performance for DirectAccess IP-HTTPS connections. TLS cipher suites are configured and optimized, TLS 1.0 and TLS 1.1 are disabled, and support for RC4 ciphers is disabled.
...
If ($OSVersion -Like '6.*') {
    ...
    If ($Performance) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
    ...
    If ($Security) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_256_GCM_SHA384,TLS_RSA_WITH_AES_256_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
If ($OSVersion -Like '*14393*' -or $OSVersion -Like '*17134 *') {
    ...
    If ($Performance) {
        ...
        Write-Verbose 'Using performance optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHATLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
If ($OSVersion -Like '*17763*' -or $OSVersion -Like '*17763*' -or $OSVersion -Like '*18362*' -or $OSVersion -Like '*18363*') {
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYJdCyqxhdlnRF0MWZm/jCNLA
# tZCgggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCcFsZ1NlI1DTKXztybGv0ah+uxTMA0G
# CSqGSIb3DQEBAQUABIIBAEP1l0zVCJVTDzTwsXI7yQQ4j96gJJERN/IanlcL44vx
# G2JJMju5l6ZjSUq8M3XJjqpyNcVajc3EBNLqDYtXk/r25V/2TpcWtDl2Uv9YLHRO
# ri3T31MV6ueAE6JUq7AGoAAb1aheC/+a9m58OLkDW4YLIbI9uccvTJhBjodT/5wV
# oyWs9Tb5WNYNi0YDxrx3sKq/SiFx7nRJCErOCVq/l4bWfZAjgG5KhqqTr7/OX+p0
# +j+1C4yNopCggaa2QmvAIWhrFHq4owZ/mJfYGYIKKVBiaFGV37yCGVKXJn6Zc4Qs
# QqtLNIyAvI/1AiPrc834BTu16Xa1x5xKxzH2Lcb1Gsw=
