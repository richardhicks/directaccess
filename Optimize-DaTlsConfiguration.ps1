...
If ($OSVersion -Like '6.*') {
    ...
    If ($Performance) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
    ...
    If ($Security) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_256_GCM_SHA384,TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
If ($OSVersion -Like '*14393*' -or $OSVersion -Like '*17134 *') {
    ...
    If ($Performance) {
        ...
        Write-Verbose 'Using performance optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_DHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_DHE_RSA_WITH_AES_256_GCM_SHA384,TLS_DHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlhFq5LSbz+vcMmqDu+vPfFja
# vXygggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIjJDBPDNLdMWDeirxmMQLSr5PTYMA0G
# CSqGSIb3DQEBAQUABIIBAHJaCYL9kYxmPiGsKZOuRovy1E6ff6Mcp3yfLQVFrJvJ
# PdzvzYct5v/IzceoUr6YEShmQdRMWbTZnuUK42hAWbao3VtZFRLi2gpQ0w+GE7VT
# iIxOA/fF9/CPiXfoO8Q0IpwvSYQ6ODTSi7tkzd6trYDR2CcyRUL8f98lktU/kj+I
# xMTYJXnru8q2nLP4lMJzFU95CsX+viFBy3xT51hCue6MIB6Yh/gwEyC1/bKtGHlv
# lJsvz9n9ztlQ4pI21KA8lOc08yh8+Gf/po4JmMB47AnXHo5Naa5HbvYFxWhNIfsZ
# xIzoR8yK7jTZb0R7AhTbv5s3K4P7CiHPMWRIfNCVXtU=
