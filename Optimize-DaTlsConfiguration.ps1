...
If ($OSVersion -Like '*14393*' -or $OSVersion -Like '*17134 *') {
    ...
    If ($Performance) {
        ...
        Write-Verbose 'Using performance optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_NULL_SHA256,TLS_RSA_WITH_NULL_SHA'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZ5aZCPl/hmK4wdH8KokKpNDN
# 8DCgggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDXuvGja1PQMZHOaXiZp2u9tX3WTMA0G
# CSqGSIb3DQEBAQUABIIBAABz+9Fa9Kk+e4JMaVrhW+ZzD5q8VHI/b+h+ixCyvb5C
# 1EPnlNO0NnxZjk9RUBAnJBQTxT+GvQ3NdjThzHN+tKiQMZxWdCm9jQxNeNdCqX3y
# DJu7KOzhZSRRHrhNV7YqOtkui/fpBWvPF0K0dw1B05GjB3b0lhl6otZF2D6Gf2Cw
# ldyofBnryudKm6aHRGUDHaC2XV1aSluuu4zLKP0X7MDCm3d0Y3jMFL4ZuWI8fceI
# PLICdZxDT0eVm5ZHnwf5Kh7QvCK6YV6Rg9Ba02bJbEOib/dpCNIkVljDXAhzvEZ6
# gIhmC8kL5J895CS3P2cnbWnldIXdZr/AL4dVLNjRCAA=
