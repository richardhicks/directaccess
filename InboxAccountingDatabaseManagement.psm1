Function Get-InboxAccountingDatabaseSize {
  ...
  <#
      ...
      .DESCRIPTION
      This function connects to the Windows Internal Database (WID) to check the Remote Access Inbox Accounting database file sizes.
...
Function Compress-InboxAccountingDatabase {
  ...
  <#
      .SYNOPSIS
      Compresses the Remote Access Inbox Accounting database.

      .DESCRIPTION
      This function connects to the Windows Internal Database (WID) to compress the Remote Access Inbox Accounting database.
  ...
  Process {
    ...
    If ($PSCmdlet.ShouldProcess('.', 'Creating index')) {
      ...
      Try {
        ...
        # // Report new database and logfile sizes
        Get-InboxAccountingDatabaseSize
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUM1glBxYFk0oUtm/U8b/D/4bZ
# DzGgggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEMd+ZXVxteQC2yaEwFq4vj21kPjMA0G
# CSqGSIb3DQEBAQUABIIBAEltWzb1OXWokmvH9HtfMNl0WDdwUBiLpjDky+2bWT7L
# moIOkBVGhthvL4sbJn/OTXeydcYJ6AsK2Tz9oCD91+/KV5m2EA2rMENrYWlOZnRf
# Ja/OvepmVHAYO4hA77slvUM+XaPFBDnlJNI3SegwFrcFRtuqMWIRRuj7w7ZBvrXm
# UkNqv6QRxzcFgXJ1h2XTPcC8es0D8IDH3UZZT5WnvXr3eVdBUUCmeKtozLPeCj6F
# ouQCuPEyDsWxgoJ/cpyWcDLvmxG7AkhtLERVBi5huiDmUhzURR+bMc7lRsLiO/2m
# RCCYdtwuRP0hd68PYxqc+f8AE+XjyJhgQszVtQSGZM4=
